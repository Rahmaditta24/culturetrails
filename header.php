...
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.min.js"></script>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>CULTURETRAILS</title>

	<link rel="icon" href="admin/img/black.png">
	...
	<style>
    /* Atur ukuran gambar menjadi sama */
    .single-gallery img {
      width: 100%;
    ...
    /* Ubah warna tulisan menjadi hitam */
	...
	<header id="header">
		...
		<div class="container main-menu">
			<div class="row align-items-center justify-content-between d-flex">
				<div id="logo">
					<a href="index.php"><img src="admin/img/logo.png" height="50px" alt="" title="" /></a>
				</div>
				<nav id="nav-menu-container">
					<ul class="nav-menu">
						<li><a href="index.php">Home</a></li>
						<li><a href="data_wisata.php">Data Cagar Budaya</a></li>
